...
package org.apache.grails.undertow.core.autoconfigure;
...
import org.apache.grails.undertow.core.ConfigurableUndertowWebServerFactory;
import org.apache.grails.undertow.core.autoconfigure.UndertowServerProperties.Accesslog;
...
public class UndertowWebServerFactoryCustomizer
    ...
    private void mapUndertowProperties(ConfigurableUndertowWebServerFactory factory, ServerOptions serverOptions) {
        ...
        // The property defaults to 2MB, matching Undertow 2.4's hardened
        // DEFAULT_MAX_ENTITY_SIZE (CVE-2024-3884, CVE-2024-4027). A non-positive
        // value is documented to mean "unlimited" and maps to an explicit -1.
        map.from(this.undertowProperties::getMaxHttpPostSize)
            .as(DataSize::toBytes)
            .as((maxHttpPostSize) -> isPositive(maxHttpPostSize) ? maxHttpPostSize : -1L)
