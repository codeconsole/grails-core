...
Output the available features and their descriptions for a given `create-\<<application-type>>` command.
Such as: `create-app`, `create-plugin`, `create-web-plugin`, etc.
...
Note: Typical output looks like this:
