...
The default HAL response content type is `application/hal+json`, however as discussed in the section on xref:mimeTypes[custom MIME types] you can define your own response content types to represent your resources.
