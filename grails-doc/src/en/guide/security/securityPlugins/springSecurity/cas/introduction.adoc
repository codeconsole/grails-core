...
The CAS plugin adds https://apereo.github.io/cas[CAS] single sign-on support to a Grails application that uses Spring Security. It depends on the xref:springSecurityCore.adoc#springSecurityCore[Spring Security Core plugin].
