...
underneath: a version that cannot be determined is left out of the banner rather than shown as `unknown`, so an
application without Spring Security says nothing about it instead of saying it does not know. See
