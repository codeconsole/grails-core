...
For a domain class shipped precompiled in a plugin, declare `Serializable id` in the plugin. The
consumer then selects the effective persistent type at runtime as well as at compilation time:
