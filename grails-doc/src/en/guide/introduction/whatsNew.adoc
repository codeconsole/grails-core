...
interceptor, another filter or Spring Security's own header writers always win. Redirects, error pages, streamed
bodies and responses served by other filters, such as asset-pipeline assets, are covered too.
