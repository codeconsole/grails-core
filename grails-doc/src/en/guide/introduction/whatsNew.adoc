...
As of Grails 7 its source has been merged into Grails core, and its reference documentation is now published as part of this guide under the xref:backgroundJobs.adoc#backgroundJobsClustered[Background Jobs > Clustered Scheduling] section.
