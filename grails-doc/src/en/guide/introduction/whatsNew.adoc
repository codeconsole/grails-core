...
As of Grails 7 its source has been merged into Grails core, and its reference documentation is now published as part of this guide under the xref:quartz.adoc#quartz[Quartz] section.
