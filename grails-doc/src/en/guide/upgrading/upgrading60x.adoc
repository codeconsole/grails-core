...
As of Grails 7, the Quartz plugin is part of Grails core and is documented in the xref:quartz.adoc#quartz[Quartz] section of this guide.
...
See the xref:quartz.adoc#quartzJobProperties[Job Properties] section for the full set of supported properties and their defaults.
