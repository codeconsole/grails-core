...
/**
 * An {@link org.grails.datastore.mapping.model.types.Identity} property with a {@link org.grails.datastore.mapping.model.PropertyMapping}
 *
 ...
 * @since 1.0
 */
public class IdentityWithMapping<T extends Property> extends Identity<T> implements PropertyWithMapping<T> {

    protected PropertyMapping<T> propertyMapping;

    public IdentityWithMapping(PersistentEntity entity, MappingContext context, PropertyDescriptor property) {
