 ...
 *
 * <p>Note: the code for this task would be simpler using groovy-yaml or similar, but the YAML
 * parsing requirements are minimal, and extra dependencies in build-logic are best avoided.</p>
 *
 * @since 8.0
 */
@CompileStatic
