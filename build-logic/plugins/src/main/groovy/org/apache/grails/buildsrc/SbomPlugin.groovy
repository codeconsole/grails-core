...
class SbomPlugin implements Plugin<Project> {
    ...
    private static Map<String, String> LICENSE_MAPPING = [
            ...
            // Groovy 6 may also pull JLine 4, handled by forcedLicenseFor below.
            ...
            'pkg:maven/org.json/json@20260719?type=jar'                       : 'Public-Domain', // required due to jedis, https://issues.apache.org/jira/browse/LEGAL-666 approves this usage
