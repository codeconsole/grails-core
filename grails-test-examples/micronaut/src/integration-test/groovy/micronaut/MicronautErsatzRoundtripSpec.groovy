...
class MicronautErsatzRoundtripSpec extends Specification implements HttpClientSupport {
    ...
    void "service fetches list via Micronaut client from ersatz mock"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test') {
                ...
                responder {
                    code(200)
                    body('[{"id":"1","name":"alpha"},{"id":"2","name":"beta"}]', 'application/json')
                }
            }
        }
    ...
    void "service fetches single resource by ID from ersatz mock"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test/7') {
                called(1)
                responder {
                    code(200)
                    body('{"id":"7","name":"gamma","active":true}', 'application/json')
                }
            }
        }
    ...
    void "service creates resource via Micronaut client through ersatz mock"() {
        ...
        ersatz.expectations {
            POST('/micronaut-test') {
                ...
                responder {
                    code(201)
                    body('{"id":"99","name":"new-item"}', 'application/json')
                }
            }
        }
    ...
    void "service updates resource via Micronaut client through ersatz mock"() {
        ...
        ersatz.expectations {
            PUT('/micronaut-test/99') {
                called(1)
                responder {
                    code(200)
                    body('{"id":"99","name":"updated-item"}', 'application/json')
                }
            }
        }
    ...
    void "service handles 500 error from external API via ersatz mock"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test/broken') {
                called(1)
                responder {
                    code(500)
                    body('{"error":"internal failure"}', 'application/json')
                }
            }
        }
    ...
    void "service handles 503 Service Unavailable from external API"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test/unavailable') {
                called(1)
                responder {
                    code(503)
                    body('{"error":"service unavailable"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: GET /external-api returns data from ersatz mock"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test') {
                ...
                responder {
                    code(200)
                    body('[{"id":"1","name":"from-ersatz"}]', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: GET /external-api/{id} returns specific resource from ersatz mock"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test/42') {
                ...
                responder {
                    code(200)
                    body('{"id":"42","name":"the-answer"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: POST /external-api creates resource via ersatz mock"() {
        ...
        ersatz.expectations {
            POST('/micronaut-test') {
                ...
                responder {
                    code(201)
                    body('{"id":"new-1","name":"created-via-roundtrip"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: PUT /external-api/{id} updates resource via ersatz mock"() {
        ...
        ersatz.expectations {
            PUT('/micronaut-test/42') {
                ...
                responder {
                    code(200)
                    body('{"id":"42","name":"updated-via-roundtrip"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: error from ersatz propagates through Grails controller"() {
        given: 'ersatz mocks a 500 Internal Server Error'
        ersatz.expectations {
            GET('/micronaut-test/fail') {
                called(1)
                responder {
                    code(500)
                    body('{"error":"boom"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: ersatz mocks different responses for sequential calls"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test/1') {
                called(1)
                responder {
                    code(200)
                    body('{"id":"1","name":"first"}', 'application/json')
                }
            }
            GET('/micronaut-test/2') {
                called(1)
                responder {
                    code(200)
                    body('{"id":"2","name":"second"}', 'application/json')
                }
            }
        }
    ...
    void "full roundtrip: ersatz mocks large JSON response"() {
        ...
        ersatz.expectations {
            GET('/micronaut-test') {
                ...
                responder {
                    code(200)
                    body(largeBody, 'application/json')
                }
            }
        }
