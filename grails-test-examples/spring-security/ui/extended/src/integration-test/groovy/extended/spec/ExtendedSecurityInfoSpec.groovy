...
@Integration
class ExtendedSecurityInfoSpec extends SecurityUISpec {
	...
	void testLogoutHandlers() {
		...
		then:
		with(pageSource) {
			contains('org.springframework.security.web.authentication.rememberme.PersistentTokenBasedRememberMeServices')
