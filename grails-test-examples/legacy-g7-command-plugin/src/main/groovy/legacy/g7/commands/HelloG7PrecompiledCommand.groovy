...
/**
 * Precompiled against Grails 7.0.10 / Groovy 4 so the monorepo can prove that an unchanged
...
class HelloG7PrecompiledCommand implements ApplicationCommand {
    ...
    boolean handle(ExecutionContext executionContext) {
        new File(executionContext.baseDir, 'hello-g7-precompiled.txt').text = 'G7-RAN'
        true
    }
}
