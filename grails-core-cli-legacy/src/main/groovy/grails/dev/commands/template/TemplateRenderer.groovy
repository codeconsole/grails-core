 ...
 * @since 3.0
 * @deprecated since 8.0, use {@link org.apache.grails.core.cli.template.TemplateRenderer}. Retained only for backwards compatibility with Grails 7 command plugins and slated for removal in a future major release.
 */
@Deprecated
