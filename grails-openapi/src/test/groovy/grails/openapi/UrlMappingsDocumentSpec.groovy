...
class UrlMappingsDocumentSpec extends Specification {
    ...
    void 'documents a statically mapped controller action'() {
        ...
        def customizer = OpenApiFixture.generator(holderFor {
        ...
        and: 'an action that is not a RestfulController action declares no response type to describe'
        openApi.paths['/books'].get.responses['200'].content == null
    }
