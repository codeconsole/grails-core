...
@CompileStatic
class DefaultWebInvocationPrivilegeEvaluator implements WebInvocationPrivilegeEvaluator {

    protected final AbstractSecurityInterceptor interceptor
    ...
    boolean isAllowed(String uri, Authentication authentication) {
        isAllowed(null, uri, null, authentication)
    }
