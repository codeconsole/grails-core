...
<body>
<s2ui:formContainer type='register' focus='username' width='40rem'>
	<s2ui:form beanName='registerCommand'>
		<g:if test='${emailSent}'>
		<p class="mb-0"><g:message code='spring.security.ui.register.sent'/></p>
		</g:if>
		<g:else>
		<s2ui:textFieldRow name='username' labelCodeDefault='Username'/>
		<s2ui:textFieldRow name='email' labelCodeDefault='E-mail'/>
