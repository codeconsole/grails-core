...
<body>
<s2ui:formContainer type='search' beanType='persistentLogin' width='40rem'>
	<s2ui:searchForm>
		<div class="mb-3">
			<label class="form-label" for="username"><g:message code='persistentLogin.username.label' default='Username'/></label>
			<g:textField name='username' class='form-control' maxlength='255' autocomplete='off' value='${username}'/>
		</div>
		<div class="mb-3">
			<label class="form-label" for="token"><g:message code='persistentLogin.token.label' default='Token'/></label>
			<g:textField name='token' class='form-control' maxlength='255' autocomplete='off' value='${token}'/>
		</div>
		<div class="mb-3">
			<label class="form-label" for="series"><g:message code='persistentLogin.series.label' default='Series'/></label>
			<g:textField name='series' class='form-control' maxlength='255' autocomplete='off' value='${series}'/>
		</div>
	</s2ui:searchForm>
</s2ui:formContainer>
<g:if test='${searched}'>
<div class="table-responsive">
	<table class="table table-striped table-hover align-middle">
		...
		<tbody>
		<g:each in='${results}' var='persistentLogin'>
			<tr>
