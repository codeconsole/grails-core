...
<body>
<s2ui:formContainer type='update' beanType='aclObjectIdentity' focus='sid' width='40rem'>
	<s2ui:form useToken="true">
		...
		<div class="mb-3">
			<g:link action='search' controller='aclEntry' params='["aclObjectIdentity.id": aclObjectIdentity.id]'>View Associated ACL Entries</g:link>
		</div>
