...
import org.apache.grails.data.hibernate5.cli.SchemaExportCommand
...
class SchemaExportCommandSpec extends Specification {
    ...
    static void main(String[] args) {
        ...
        def hibernateDatastore = new HibernateDatastore(Hibernate5SchemaExportLoggingEntity)
        ...
        def targetDirectory = File.createTempDir('hibernate5-schema-export', '')
        def commandLine = [
...
@Entity
class Hibernate5SchemaExportLoggingEntity {
    Long id
    String name
}
