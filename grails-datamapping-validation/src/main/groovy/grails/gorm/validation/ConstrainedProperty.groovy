...
interface ConstrainedProperty extends Constrained {
    ...
    String DEFAULT_NOT_UNIQUE_MESSAGE_CODE = 'default.not.unique.message'
    ...
    Map<String, String> DEFAULT_MESSAGES = [
            ...
            (DEFAULT_INVALID_EMAIL_MESSAGE_CODE): DEFAULT_INVALID_EMAIL_MESSAGE,
            (DEFAULT_INVALID_MAX_MESSAGE_CODE): DEFAULT_INVALID_MAX_MESSAGE,
            (DEFAULT_INVALID_MAX_SIZE_MESSAGE_CODE): DEFAULT_INVALID_MAX_SIZE_MESSAGE,
            (DEFAULT_INVALID_MIN_MESSAGE_CODE): DEFAULT_INVALID_MIN_MESSAGE,
            (DEFAULT_INVALID_MIN_SIZE_MESSAGE_CODE): DEFAULT_INVALID_MIN_SIZE_MESSAGE,
            (DEFAULT_INVALID_RANGE_MESSAGE_CODE): DEFAULT_INVALID_RANGE_MESSAGE,
            (DEFAULT_INVALID_SIZE_MESSAGE_CODE): DEFAULT_INVALID_SIZE_MESSAGE,
            (DEFAULT_INVALID_URL_MESSAGE_CODE): DEFAULT_INVALID_URL_MESSAGE,
            (DEFAULT_NOT_EQUAL_MESSAGE_CODE): DEFAULT_NOT_EQUAL_MESSAGE,
            (DEFAULT_NOT_INLIST_MESSAGE_CODE): DEFAULT_NOT_IN_LIST_MESSAGE,
